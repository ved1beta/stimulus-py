...
def arg_parser():
    ...
    parser.add_argument(
        "--input",
        type=str,
        help="Path to input csv file, should be identical to Kaggle download of the Titanic dataset, see : https://www.kaggle.com/c/titanic/data",
        required=True,
    )
    parser.add_argument(
        "--output",
...
def main():
    ...
    df = df.rename(
        {
            "Survived": "survived:label:int_class",
