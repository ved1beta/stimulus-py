...
def titanic_yaml_config(titanic_config_path):
    ...
    with open(titanic_config_path, "r") as file:
...
def test_init_handlertorch(titanic_config_path, titanic_csv_path, titanic_encoder_loader):
    handlertorch.TorchDataset(config_path=titanic_config_path, csv_path=titanic_csv_path, encoder_loader=titanic_encoder_loader)

def test_len_handlertorch(titanic_config_path, titanic_csv_path, titanic_encoder_loader):
    dataset = handlertorch.TorchDataset(config_path=titanic_config_path, csv_path=titanic_csv_path, encoder_loader=titanic_encoder_loader)
