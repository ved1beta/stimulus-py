...
class TextOneHotEncoder(AbstractEncoder):
    ...
    def __init__(self, alphabet: str = "acgt") -> None:
        ...
        self.encoder = preprocessing.OneHotEncoder(categories=[list(alphabet)], handle_unknown='ignore') # handle_unknown='ignore' unsures that a vector of zeros is returned for unknown characters, such as 'Ns' in DNA sequences
